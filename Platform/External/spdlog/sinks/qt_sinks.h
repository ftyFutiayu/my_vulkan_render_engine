        ...
        protected:
            struct invoke_params {
                invoke_params(int max_lines, QTextEdit *q_text_edit, QString payload, QTextCharFormat default_color,
                        ...
                        : max_lines(max_lines), q_text_edit(q_text_edit), payload(std::move(payload)),
                          default_color(default_color), level_color(level_color), color_range_start(color_range_start),
