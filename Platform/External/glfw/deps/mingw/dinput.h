...
typedef BOOL (CALLBACK *LPDIENUMDEVICESBYSEMANTICSCBA)(LPCDIDEVICEINSTANCEA, LPDIRECTINPUTDEVICE8A, DWORD, DWORD,
                                                       LPVOID);

typedef BOOL (CALLBACK *LPDIENUMDEVICESBYSEMANTICSCBW)(LPCDIDEVICEINSTANCEW, LPDIRECTINPUTDEVICE8W, DWORD, DWORD,
                                                       LPVOID);
...
DECLARE_INTERFACE_(IDirectInputDevice7W, IDirectInputDevice2W) {
    ...
    STDMETHOD(EnumEffectsInFile)(THIS_ LPCWSTR lpszFileName, LPDIENUMEFFECTSINFILECALLBACK pec, LPVOID pvRef,
                                 DWORD dwFlags) PURE;

    STDMETHOD(WriteEffectToFile)(THIS_ LPCWSTR lpszFileName, DWORD dwEntries, LPDIFILEEFFECT rgDiFileEft,
                                 DWORD dwFlags) PURE;
};
...
DECLARE_INTERFACE_(IDirectInputW, IUnknown) {
    ...
    STDMETHOD(EnumDevices)(THIS_ DWORD dwDevType, LPDIENUMDEVICESCALLBACKW lpCallback, LPVOID pvRef,
                           DWORD dwFlags) PURE;
...
DECLARE_INTERFACE_(IDirectInput8W, IUnknown) {
    ...
    STDMETHOD(CreateDevice)(THIS_ REFGUID rguid, LPDIRECTINPUTDEVICE8W *lplpDirectInputDevice,
                            LPUNKNOWN pUnkOuter) PURE;
    ...
    STDMETHOD(EnumDevicesBySemantics)(THIS_ LPCWSTR ptszUserName, LPDIACTIONFORMATW lpdiActionFormat,
...
#if DIRECTINPUT_VERSION >= 0x0800
HRESULT WINAPI DirectInput8Create(HINSTANCE, DWORD,
REFIID , LPVOID * , LPUNKNOWN ) ;
#else /* DI < 8 */
